...
.. code-block::
    ...
    sources/
    ├── copiertv/          # Main Python package
    │   ├── __/                      # Centralized import hub
    │   │   ├── __init__.py          # Re-exports core utilities
    │   │   ├── imports.py           # External library imports
    │   │   └── nomina.py            # copier-template-validator-specific naming constants
    │   ├── __init__.py              # Package entry point
    │   ├── py.typed                 # Type checking marker
    │   ├── __main__.py              # CLI entry point for `python -m copiertv`
...
.. code-block::
    ...
    copiertv/
    ├── __main__.py      # Entry point: `python -m copiertv`
...
Package-wide exceptions are centralized in ``sources/copiertv/exceptions.py``
